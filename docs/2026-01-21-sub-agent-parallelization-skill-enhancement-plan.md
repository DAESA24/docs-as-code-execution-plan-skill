...
|-------|-------------|-------------------|--------|
| Pre-Flight | Verify skill files exist | All paths accessible | Pending |
| Phase 1 | Dependency verification | No conflicts detected | Pending |
| Phase 2 | Guide pattern addition | Pattern in guide, no broken refs | Pending |
| Phase 3 | Template field additions | Fields in template, valid structure | Pending |
| Phase 4 | SKILL.md updates | Mode 1/2 updated, Quality Checklist updated | Pending |
| Phase 5 | Final validation | Skill validates, test plan works | Pending |
...
- [ ] Skill directory exists at ~/.claude/skills/docs-as-code-execution-plan/
- [ ] All three core files exist (guide, template, SKILL.md)
- [ ] Guide has Critical Patterns section
- [ ] Template has Autonomous marker
...
- [ ] No existing "parallelization" references conflict with proposed terminology
- [ ] No existing "sub-agent" references conflict with proposed terminology
- [ ] No existing "Dependencies:" field in template
...
- [ ] Pattern 7 added after Pattern 6 in Critical Patterns section
- [ ] Pattern includes "When to Use" criteria
- [ ] Pattern includes "When NOT to Use" criteria
- [ ] Pattern includes phase-level annotation example
- [ ] Pattern includes step-level annotation example
- [ ] Pattern includes sub-agent task prompt template
- [ ] Pattern includes orchestrator validation flow
...
- [ ] Note added to Explicit Execution Rules section
- [ ] Note clarifies parallelization is opt-in
- [ ] Note references annotation markers
...
- [ ] Pattern 7 header present in guide
- [ ] Orchestrator Verification content present
- [ ] Sub-Agent Task Prompt Template present
- [ ] Parallelization note in Execution Rules section
...
- [ ] Dependencies field added as optional comment
- [ ] Parallelizable field added as optional comment
- [ ] Output Artifacts section added as optional comment
- [ ] Orchestrator Verification section added as optional comment
...
- [ ] Phase parallelization summary added as optional comment
- [ ] Example shows both parallel and sequential requirements
...
- [ ] Parallelization evaluation instruction added to Execution Instructions
...
- [ ] Dependencies field present in template
- [ ] Parallelizable field present in template
- [ ] Output Artifacts section present in template
- [ ] Orchestrator Verification section present in template
- [ ] Parallelization instruction in Execution Instructions
...
- [ ] Step 4 "Post-Draft Parallelization Review" added to Mode 1
- [ ] Step references Pattern 7 in guide
- [ ] Step lists decision criteria
- [ ] Step clarifies sequential is default
...
- [ ] Step 2 "Check for parallelization annotations" added to Mode 2
- [ ] Step includes sub-agent spawn instructions
- [ ] Step includes orchestrator verification instructions
- [ ] Step clarifies fallback to sequential execution
...
- [ ] Four new optional Quality Checklist items added
- [ ] Items are clearly marked as conditional "(If parallel)"
...
- [ ] Mode 1 has "Post-Draft Parallelization Review" step
- [ ] Mode 2 has "Check for parallelization annotations" step
- [ ] Quality Checklist has "(If parallel)" items
...
- [ ] References directory exists with guide and template
...
- [ ] Guide has Pattern 7: Sub-Agent Parallelization
- [ ] Template references parallelization
- [ ] All files use consistent terminology (sub-agent, not subagent)
...
- [ ] Changes confirmed as additive (no breaking changes)
...
- [ ] Guide contains Pattern 7: Sub-Agent Parallelization
- [ ] Template contains optional parallelization fields
- [ ] SKILL.md Mode 1 includes parallelization review step
- [ ] SKILL.md Mode 2 includes parallel execution path
- [ ] Quality Checklist includes parallelization items
...
- **Executed By:** (to be filled after execution)
...
1. (to be filled after execution)
